            ...
            if ($_POST['password'] === $_POST['password2']) {
                ...
                if(in_array($photoType, $allowTypes) && move_uploaded_file($_FILES["photo"]["tmp_name"], $targetPhotoPath)) {
                    if ($type == "student" || $type == "staff") {
                        ...
                        $sql = "INSERT INTO foodvendor VALUES ('', NULL, '$name', '$phoneNum', '$email', '$username', '$password', '$photo', NULL)";
                        $conn->exec($sql);
                    }
                }
            }
...
<body>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-6">
                <?php if (isset($type)): ?>
                <h4>Dear vendor, your registration form has been submitted and pending for admin's approval. Please be patient.</h4>
                <?php endif; ?>
            </div>            
        </div>
